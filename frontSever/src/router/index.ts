...
const routes = [
    { path: '/', component: () => import('@/views/Home/HomeIndex.vue'), meta: { title: '🦄欢迎来到江江的温柔乡',keepAlive: true }},
    { path: '/Task', component: () => import('@/views/Task/TaskIndex.vue'), meta: { title: '🦄欢迎来到任务中心',keepAlive: true } },
    { path: '/Produce', component: () => import('@/views/Produce/ProduceIndex.vue'), meta: { title: '🦄欢迎来到积分商城',keepAlive: true } },
    { path: '/Room', component: () => import('@/views/Room/RoomIndex.vue'), meta: { title: '🦄欢迎来到仓库',keepAlive: true } },
    { path: '/User', component: () => import('@/views/User/UserIndex.vue'), meta: { title: '🦄欢迎来到用户中心',keepAlive: true } },
    ...
    // 登录
    { path: '/login', component: () => import('@/views/login/loginIndex.vue'), meta: { title: '登录-欢迎坠入爱河~' } },
    // 注册
    { path: '/userAdd', component: () => import('@/views/Add/UserAddIndex.vue'), meta: { title: '注册-恭喜您即将陷入温柔乡~' } },

    { path: '/test/:id', component: () => import('@/views/Test/TestIndex.vue'), meta: { title: '欢迎-来到虚无' } },
